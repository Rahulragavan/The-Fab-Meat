...
const Products = () => {
    const listings = [
        {
          "id": 1,
          "name": "Goat Mutton Curry Cut (Net weight 450gms)",
          "image":  require( "./img/itm1.webp"),
          "price":"Rs.170.00"
        },
        {
          "id": 2,
          "name": "Mutton-Biryani Cut-500gms ( 450 gms)",
          "image":  require( "./img/itm2.webp"),
          "price":"Rs.180.00"
        },
        {
          "id": 3,
          "name": "Mutton Paya Bones ( 4 Legs Cut 16 Pcs)",
          "image":  require( "./img/itm3.webp"),
          "price":"Rs.180.00"
        },
        {
          "id": 4,
          "name": "Mutton Kheema - 500 gms (480 gms)",
          "image": require( "./img/itm4.webp"),
          "price":"Rs.170.00"
        },
        {
          "id": 5,
          "name": "Mutton Liver (250 gms)",
