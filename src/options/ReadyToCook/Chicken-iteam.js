...
const Products = () => {
    const listings = [
        {
          "id": 1,
          "name": "Marinated Chicken Lollipop - 10 pcs",
          "image":  require( "./img/itm1.webp"),
          "price":"Rs.370.00"
        },
        {
          "id": 2,
          "name": "Schezwan Chicken - 4 pcs (400 gms)",
          "image":  require( "./img/itm2.webp"),
          "price":"Rs.480.00"
        },
        {
          "id": 3,
          "name": "Tandoori Chicken - 4 to 5 pcs (400 gms)",
          "image":  require( "./img/itm3.webp"),
          "price":"Rs.280.00"
        },
        {
          "id": 4,
          "name": "Malai tikka - 250 gms",
          "image": require( "./img/itm4.webp"),
          "price":"Rs.370.00"
        },
        {
          "id": 5,
          "name": "Lemon Pepper Boneless Tikka - 250gms",
          "image":  require( "./img/itm5.avif"),
          "price":"Rs.265.00"
        },
        {
          "id": 6,
          "name": "Achaari Prawns - 250gms",
        ...
        {
            "id": 7,
            "name": "Hariyali drumsticks - 5pcs",
            "image":  require( "./img/itm7.webp"),
            "price":"Rs.350.00"
          },
          {
            "id": 8,
            "name": "Jamacin Jerk Boneless Tikka - 250 gms",
